...
with open('/Users/kushalbanda/Applications/VsCode/Kushal/FSDS/2. CV/Projects/1. Car Park/CarParkPos', 'rb') as f:
...
while True:
    ...
    imgGray = cv2.cvtColor(img, cv2.COLOR_BAYER_BG2BGR)
